...
const data = [
  ...
  },
  {
    ...
    title: "نظرة عامة",
    content:
     " تعتبر مجموعة شركات الظاهري وفروعها من الشركات الرائدة في المملكة العربية السعودية ومنطقة الخليج. تأسست عام 1403 هـ - 1983 م بواسطة الشيخ الدكتور / محمد بن صالح الظاهري وبدأت بقطاع المقاولات إلى أن أمتد نشاطها إلي (10) فروع وشركات في مختلف النشاطات , و تشمل الإعاشة والخدمات والتشغيل و مقاولون عامون و فرع التوكيلات التجارية",
  },
  {
    id: 3,
...
/* ===== Counter Component ===== */
function Counter({ end, icon: Icon, title }) {
